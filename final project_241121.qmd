...
ggplot(merged_dementia1, aes(chd11educ)) + 
    geom_histogram(breaks = seq(0, 8, 1), 
                   color = "blue", fill = "blue", alpha = 0.7) 
...
vip(rf_engine)
importance_values <- importance(rf_engine)
...
```{r}
system("quarto render final_project_241121.qmd --to html")
